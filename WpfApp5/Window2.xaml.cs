...
namespace WpfApp5
{
    ...
    public partial class Window2 : Window
    {
        ...
        public Window2(int value, int pin, string name)
        {
            InitializeComponent();
        ...
        private void From_1_to_2_button_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void From_1_to_3_button_Click(object sender, RoutedEventArgs e)
        {
            if (rectangles_1.Count == 0) { System.Windows.Forms.MessageBox.Show("Стержень пуст!", "Ошибка"); }
        ...
        private void From_2_to_1_button_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void From_2_to_3_button_Click(object sender, RoutedEventArgs e)
        {
            if (rectangles_2.Count == 0) { System.Windows.Forms.MessageBox.Show("Стержень пуст!", "Ошибка"); }
        ...
        private void From_3_to_1_button_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void From_3_to_2_button_Click(object sender, RoutedEventArgs e)
        {
            if (rectangles_3.Count == 0) { System.Windows.Forms.MessageBox.Show("Стержень пуст!", "Ошибка"); }
